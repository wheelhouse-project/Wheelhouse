...
class DistilMediumServer:
    ...
    def __init__(
        ...
        # Whether this engine applies a saved hint
        # (wh-boost-engine-qualification): the startup [hotwords] enabled
        # flag, not whether a hotwords string was built, so the first
        # "boost" with boosting on and no hint saved yet is accepted.
        # WheelHouse types the word "boost" as dictation when this is
        # False.
